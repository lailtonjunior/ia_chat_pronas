...
export default function NotificationCenter() {
  ...
  return (
    <div className="relative notification-tour" ref={containerRef}>
      <button
              ...
              formattedNotifications.map((notification) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-full bg-blue-100 text-blue-800 flex items-center justify-center text-sm font-semibold">
